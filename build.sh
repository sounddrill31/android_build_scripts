...
rm -rf packages/apps/Settings frameworks/base vendor/plros/prebuilt/apps/Cromite ; \
# cd frameworks/base ; git am --abort ; cd ../../packages/apps/Settings ;git am --abort; cd ../../.. \
# Initialize repo with specified manifest
