...
rm -rf  frameworks/base packages/apps/Settings vendor/plros/prebuilt/apps/Cromite ; \
cd frameworks/base && git rebase --abort && cd ../../packages/apps/Settings && git rebase --abort; \
# Initialize repo with specified manifest
