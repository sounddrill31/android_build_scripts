...
rm -rf .repo/projects/frameworks/base.git .repo/projects/packages/apps/Settings.git frameworks/base packages/apps/Settings vendor/plros/prebuilt/apps/Cromite ; \
# Initialize repo with specified manifest
